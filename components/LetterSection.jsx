      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          >
            ...
            <p className="mt-8 text-[#1F3A5F] font-inter font-medium">
          ...
          >
            <div className="relative w-full aspect-[3/4] md:aspect-[4/5] rounded-lg overflow-hidden bg-[#2D2D2D]/5 shadow-lg">
              <Image
